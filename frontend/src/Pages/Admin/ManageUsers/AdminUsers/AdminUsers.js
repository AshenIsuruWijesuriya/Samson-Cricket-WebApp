...
const AdminUsers = () => {
    ...
    const fetchUsers = useCallback(async () => {
        try {
            ...
            const response = await axios.get(`${api}/api/users/role/Admin`, {});
        ...
        <div className="admin-users-bg">
            <div className="admin-users-content">
                ...
                <div className="navigation-path-admindb">
                    ...
                    <a href="/admindashboard/manage-users">Manage Users</a> / Admin Users
                </div>
                <h2 className="admin-users-title">Manage Admin Users</h2>
                ...
                <div className="admin-users-filter-container">
                    ...
                    <button onClick={handleOpenModal} className="add-admin-user-link">
                        <FaPlus className="add-admin-user-icon" /> Add New Admin User
                    </button>
                </div>

                {isModalOpen && <AddAdminUserModal onClose={handleCloseModal} onUserAdded={handleUserAdded} />}
