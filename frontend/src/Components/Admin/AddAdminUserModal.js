...
const AddAdminUserModal = ({ onClose, onUserAdded }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire({ title: 'Success!', text: 'Admin user successfully added!', icon: 'success', confirmButtonText: 'OK' });
            onUserAdded();
            onClose();
        } catch (error) {
    ...
    return (
        <div className="admin-user-modal-overlay">
            <div className="admin-user-modal-content">
                <h2 className="admin-user-modal-title">Add New Admin User</h2>
